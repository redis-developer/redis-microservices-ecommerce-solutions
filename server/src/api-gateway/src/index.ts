...
const ORDERS_API_URL = SERVER_CONFIG.ORDERS_SERVICE.SERVER_ORIGIN + ":" + SERVER_CONFIG.ORDERS_SERVICE.PORT;

const ORDER_HISTORY_API_PREFIX = SERVER_CONFIG.ORDER_HISTORY_SERVICE.API.PREFIX;
const ORDER_HISTORY_API_URL = SERVER_CONFIG.ORDER_HISTORY_SERVICE.SERVER_ORIGIN + ":" + SERVER_CONFIG.ORDER_HISTORY_SERVICE.PORT;

const PRODUCTS_API_PREFIX = SERVER_CONFIG.PRODUCTS_SERVICE.API.PREFIX;
const PRODUCTS_API_URL = SERVER_CONFIG.PRODUCTS_SERVICE.SERVER_ORIGIN + ":" + SERVER_CONFIG.PRODUCTS_SERVICE.PORT;
...
app.use(PRODUCTS_API_PREFIX, createProxyMiddleware({
