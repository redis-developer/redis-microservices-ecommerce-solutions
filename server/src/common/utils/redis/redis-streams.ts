...
const listenToStream = async (options: listenStreamOptions) => {
    ...
    if (nodeRedisClient) {
        ...
        try {
            ...
            await nodeRedisClient.xGroupCreate(streamKeyName, groupName, idPosition, { MKSTREAM: true });
                ...
                if (dataArr && dataArr.length) {
                    for (let data of dataArr) {
                        ...
                        for (let messageItem of data.messages) {
                            ...
                            await options.processMessageCallback(messageItem.message, messageItem.id);
